...
public sealed record ChartSeriesRelationalModelHash : IDeterminedHash
{
    ...
    public ChartSeriesRelationalModelHash(IChartSeriesRelationalModel model)
        : this(
            model.Id,
            model.ChartId,
            model.Legend,
    ...
    public ChartSeriesRelationalModelHash(
        IGuid id,
        IGuid chartId,
        IString legend,
        IString xAxisSource,
